...
This document is a technical control mapping for Editra 1.0.1. It is not a certification. Compliance belongs to the complete deployed application, including identity, APIs, storage, infrastructure, monitoring, policies, and operating procedures.
